...
hi CursorLine guibg=#383733 
hi ColorColumn guibg=#4B4944

hi Normal      guibg=#2B2A27  guifg=#EDE0CE    gui=none ctermbg=0 ctermfg=15
hi NonText     guibg=#23221F  guifg=#23221F   ctermbg=8 ctermfg=14
...
function! InsertStatusLineColor(mode)
  if a:mode == 'i'
    ...
    hi CursorLine guibg=#191917
  elseif a:mode == 'r'
    hi StatusLine guifg=#cccccc guibg=black
    hi CursorLine guibg=#191917
  else
    hi StatusLine guibg=white guifg=#cc4455
    hi CursorLine guibg=#383733
  endif
endfunction
...
au InsertLeave * call InsertStatusLineColor('_')

hi StatusLine     guibg=white  guifg=#cc4455     ctermbg=14 ctermfg=0
hi StatusLineNC   guibg=black  guifg=white    gui=none ctermbg=4  ctermfg=11
hi VertSplit      guibg=black  guifg=black    gui=none ctermbg=4  ctermfg=11
